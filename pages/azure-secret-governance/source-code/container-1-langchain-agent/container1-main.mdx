...
All tools POST to Container 2 `/tools/*` endpoints:

| Tool | Container 2 endpoint |
|------|---------------------|
| `run_secret_monitoring` | `/tools/run_secret_monitoring` |
| `fetch_azure_secrets` | `/tools/fetch_azure_secrets` |
| `get_sharepoint_state` | `/tools/get_sharepoint_state` |
| `get_jira_issue` | `/tools/get_jira_issue` |
| `add_jira_comment` | `/tools/add_jira_comment` |
| `send_teams_alert` | `/tools/send_teams_alert` |
| `write_sharepoint_row` | `/tools/write_sharepoint_row` |
| `create_jira_ticket` | `/tools/create_jira_ticket` |
...
# ── Teams Bot — comment out to disable ───────────────────────────────────────
...
async def _update_sharepoint_on_close(jira_key: str):
    try:
        ...
        result = await _call_monitor("update_on_jira_close", {"jira_key": jira_key, "today": today})
