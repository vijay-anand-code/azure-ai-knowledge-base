...
# CORRECTED (v3) — matches decision_engine.py's current bucket names.
ROTATION_ELIGIBLE_BUCKETS  = {"P1", "P2", "P3", "P4"}
...
def _classify_bucket(days: int) -> str:
    """CORRECTED (v3) — matches decision_engine.py's classify_bucket() exactly."""
